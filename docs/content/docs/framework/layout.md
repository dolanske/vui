...
| ----------------- | ----------------------------------------------------------------------------------------------------------- | ---------------------- | -------- |
| `.container`      | Default container with auto margins and padding. This class is required to make other container sizes work. | `var(--container-l)`   | `1140px` |
| `.container-xs`   | Extra small container                                                                                       | `var(--container-xs)`  | `360px`  |
| `.container-s`    | Small container                                                                                             | `var(--container-s)`   | `498px`  |
| `.container-m`    | Medium container                                                                                            | `var(--container-m)`   | `856px`  |
| `.container-l`    | Large container                                                                                             | `var(--container-l)`   | `1140px` |
| `.container-xl`   | Extra large container                                                                                       | `var(--container-xl)`  | `1540px` |
| `.container-xxl`  | Extra extra large container                                                                                 | `var(--container-xxl)` | `1920px` |
...
- `.w-100` - Sets width to 100% (full width)
- `.w-auto` - Sets width to auto

**Available classes:** `.w-0`, `.w-5`, `.w-10`, `.w-15`, `.w-20`, `.w-25`, `.w-30`, `.w-35`, `.w-40`, `.w-45`, `.w-50`, `.w-55`, `.w-60`, `.w-65`, `.w-70`, `.w-75`, `.w-80`, `.w-85`, `.w-90`, `.w-95`, `.w-100`, `.w-auto`
...
**Available classes:** `.h-0`, `.h-5`, `.h-10`, `.h-15`, `.h-20`, `.h-25`, `.h-30`, `.h-35`, `.h-40`, `.h-45`, `.h-50`, `.h-55`, `.h-60`, `.h-65`, `.h-70`, `.h-75`, `.h-80`, `.h-85`, `.h-90`, `.h-95`, `.h-100`
