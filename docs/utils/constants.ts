...
export const componentList = [
  ...
  { name: 'Button', path: '/docs/components/button', tags: ['group'], keywords: ['click', 'action', 'submit', 'trigger'], description: 'Interactive element for triggering actions or events' },
