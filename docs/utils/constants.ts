...
export const componentList = [
  ...
  { name: 'Sidebar TODO', path: '/docs/components/sidebar', description: 'Vertical navigation panel typically on screen edges' },
  ...
  { name: 'Table TODO', path: '/docs/components/table', tags: ['cell', 'head', 'header', 'row', 'select'], description: 'Data display component with rows and columns' },
