...
export const componentList = [
  ...
  { name: 'Aspect Ratio', path: '/docs/components/aspect-ratio', keywords: ['ratio', 'image', 'video', 'responsive', 'container'], description: 'Constrains content to a given aspect ratio while filling available width' },
  ...
  { name: 'Badge Group', path: '/docs/components/badge-group', tags: ['group'], keywords: ['badge', 'group', 'label', 'cluster'], description: 'Groups multiple Badge components together with merged or spaced borders' },
  ...
  { name: 'Charts', path: '/docs/components/charts', keywords: ['histogram', 'bar', 'data', 'visualization'], description: 'Collection of chart components for visualizing data' },
  ...
  { name: 'Context Menu', path: '/docs/components/context-menu', keywords: ['right-click', 'menu', 'context', 'popup'], description: 'Floating menu that appears on right-click at the cursor position' },
  ...
  { name: 'Menubar', path: '/docs/components/menubar', tags: ['item'], keywords: ['menu', 'toolbar', 'navigation', 'file', 'edit'], description: 'Horizontal menu bar with labeled triggers that open floating menus on click' },
  ...
  { name: 'Overflow', path: '/docs/components/overflow', keywords: ['scroll', 'container', 'shadow', 'clip'], description: 'Scrollable container with gradient shadow indicators for overflowing content' },
  ...
  { name: 'Popout Hover', path: '/docs/components/popout-hover', keywords: ['popup', 'hover', 'floating', 'interactive', 'tooltip'], description: 'Floating interactive popout triggered by hover or focus events' },
  ...
  { name: 'Resizable', path: '/docs/components/resizable', keywords: ['split', 'panel', 'drag', 'layout'], description: 'Layout container that splits content into resizable panels', status: 'update' },
  ...
  { name: 'Slider', path: '/docs/components/slider', keywords: ['range', 'input', 'drag', 'value', 'step'], description: 'Draggable input for selecting a numeric value or range' },
  ...
  { name: 'Table', path: '/docs/components/table', tags: ['cell', 'head', 'header', 'row', 'select'], keywords: ['data', 'rows', 'columns', 'grid'], description: 'Data display component with rows and columns', status: 'update' },
...
export const tokenPages = [
  { label: 'Getting started', path: '/docs/tokens', keywords: ['install', 'setup', 'variables', 'css'] },
  { label: 'Colors', path: '/docs/tokens/colors', keywords: ['color', 'palette', 'hue', 'accent'] },
  { label: 'Theming', path: '/docs/tokens/theming', keywords: ['theme', 'dark', 'light', 'mode'] },
  { label: 'Text & Font', path: '/docs/tokens/text', keywords: ['text', 'font', 'weight', 'line', 'height'] },
  { label: 'Spacing', path: '/docs/tokens/spacing', keywords: ['spacing', 'margin', 'padding', 'gap'] },
  { label: 'Layout', path: '/docs/tokens/layout', keywords: ['layout', 'grid', 'flex', 'container', 'height'] },
  { label: 'Border radius', path: '/docs/tokens/border-radius', keywords: ['rounded', 'corners'] },
  { label: 'Shadows', path: '/docs/tokens/shadows', keywords: ['shadow', 'elevation', 'depth', 'box'] },
  { label: 'Transitions', path: '/docs/tokens/transitions', keywords: ['transition', 'animation', 'easing', 'duration'] },
  { label: 'Z-index', path: '/docs/tokens/z-index', keywords: ['z-index', 'stacking', 'order', 'layer'] },
]
...
export const componentPages = [
  ...
  ...[...componentList].sort((a, b) => a.name.localeCompare(b.name)).map(component => ({
