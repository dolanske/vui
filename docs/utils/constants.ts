...
export const componentList = [
  ...
  { name: 'Input', path: '/docs/components/input', description: 'Standard text input field for single-line text entry' },
  { name: 'Color', path: '/docs/components/color', description: 'Color picker input for selecting colors' },
  { name: 'Counter', path: '/docs/components/counter', description: 'Input field with character count and limit functionality' },
  { name: 'Dropzone', path: '/docs/components/dropzone', description: 'Drag and drop area for file uploads' },
  { name: 'File', path: '/docs/components/file', description: 'File upload input with preview and management' },
  { name: 'Password', path: '/docs/components/password', description: 'Secure text input with show/hide password toggle' },
  { name: 'Textarea', path: '/docs/components/textarea', description: 'Multi-line text input for longer content' },
