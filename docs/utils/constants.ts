...
export const componentList = [
  ...
  { name: 'Aspect Ratio', path: '/docs/components/aspect-ratio', keywords: ['ratio', 'image', 'video', 'responsive', 'container'], description: 'Constrains content to a given aspect ratio while filling available width', status: 'new' },
  ...
  { name: 'Context Menu', path: '/docs/components/context-menu', keywords: ['right-click', 'menu', 'context', 'popup'], description: 'Floating menu that appears on right-click at the cursor position', status: 'new' },
