...
export const componentList = [
  ...
  { name: 'Resizable', path: '/docs/components/resizable', keywords: ['split', 'panel', 'drag', 'layout'], description: 'Layout container that splits content into resizable panels', status: 'new' },
