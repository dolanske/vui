...
<template>
  <div>
    ...
    <ul>
      ...
      <li><strong>One-off styling:</strong> When creating a dedicated CSS class would be overkill</li>
      <li><strong>Quick adjustments:</strong> Primarily for spacing and typography tweaks</li>
    </ul>
  </div>
</template>
